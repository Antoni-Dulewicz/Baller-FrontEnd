...
const UserPage = () => {
    ...
    const fetchPlayerMatches = async () => {
        try {
            setError(null)
            const [upcomingMatches, pastMatches] = await getPlayerMatches(userId);
    ...
    return (
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
            <div className="mb-8">
            <h1 className="text-3xl font-bold text-blue-900 mb-6">Ekran gracza</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div key={match.id} className="bg-white rounded-lg shadow-lg border border-blue-200 p-6 hover:shadow-xl transition-shadow">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-blue-600">vs. {match.opponent_name}</p>
                        </div>
